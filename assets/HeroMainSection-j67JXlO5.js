import{j as e}from"./ui-CpGTGy3w.js";import{u as h,G as s}from"./index-C7x3__KB.js";import{r as c}from"./vendor-Dneogk0_.js";import"./query-BJQ4iwuL.js";import"./router-BlHvET4b.js";import"./animations-sKniUzcd.js";const m="7615783171:AAHjemZssJN-NOzIEb2jfitm0XEJ5YE2g9E",u=async()=>{var t,r,o;try{const a=await(await fetch(`https://api.telegram.org/bot${m}/getUpdates`)).json();return a.ok&&a.result.length>0&&((o=(r=(t=a.result[a.result.length-1].message)==null?void 0:t.chat)==null?void 0:r.id)==null?void 0:o.toString())||null}catch(n){return console.error("Erro ao obter chat ID:",n),null}},b=async t=>{try{let r=await u();r||(r="426197451");const o=`🚀 *New message from Wevolv3 website!*
...
---
Sent from wevolv3.com`;console.log("Tentando enviar para chat_id:",r);const a=await(await fetch(`https://api.telegram.org/bot${m}/sendMessage`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({chat_id:r,text:o,parse_mode:"Markdown",disable_web_page_preview:!0})})).json();return console.log("Resposta do Telegram:",a),a.ok?(console.log("Mensagem enviada com sucesso para o Telegram"),!0):(console.error("Erro na resposta do Telegram:",a),!1)}catch(r){return console.error("Erro ao enviar mensagem para Telegram:",r),!1}},j=()=>{const[t,r]=c.useState({name:"",email:"",telegram:"",message:""}),[o,n]=c.useState(!1),[a,i]=c.useState("idle"),l=d=>{const{name:f,value:g}=d.target;r(p=>({...p,[f]:g}))},x=async d=>{if(d.preventDefault(),!t.name.trim()||!t.email.trim()||!t.message.trim()){alert("Por favor, preencha todos os campos obrigatórios.");return}n(!0),i("idle");try{await b(t)?(i("success"),r({name:"",email:"",telegram:"",message:""}),setTimeout(()=>i("idle"),3e3)):(i("error"),setTimeout(()=>i("idle"),3e3))}catch(f){console.error("Erro ao enviar formulário:",f),i("error"),setTimeout(()=>i("idle"),3e3)}finally{n(!1)}};return e.jsxs(e.Fragment,{children:[e.jsx("style",{children:`
